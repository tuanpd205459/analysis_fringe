...
%
% VERSION: 2.1 (Đã thêm phần hiển thị sai lệch trước và sau giải bọc)
% =========================================================================

%% === KHỞI TẠO MÔI TRƯỜNG ===
clc;            % Xóa Command Window
clear;          % Xóa tất cả biến khỏi Workspace
...
finalUnwrappedPhase = remove_tilt_from_wrapped2(finalUnwrappedPhase);
...
fprintf('   -> Tính toán sai số hoàn tất.\n');
