%%
% chayj nhieu anh cung 1 muc nhieu:
clc, clear, close all;

K = 100;
noise_sigma = 0.1;

results = zeros(K, 5);   % Lưu RMSE các thuật toán
phi_GT_all = cell(K,1);
phi_wrapped_all = cell(K,1);
...
load("my_create_zernike.mat"); %be mat mo phong
...
for idxSNR = 1:length(snr_values)
    ...
    object_phase_without_noise = surface_HCN;
    ...
    final_phi_wls = phi_wls;
    final_phi_quality = phi_quality;
